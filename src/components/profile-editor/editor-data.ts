...
export const exportPresets: ExportPreset[] = [
  ...
  { id: "slack", label: "Slack", size: 512, note: "Official: 512×512 minimum, up to 1024×1024 · PNG keeps the corners transparent, though Slack may show its own background behind them", source: "https://slack.com/help/articles/115005506003-Upload-a-profile-photo", official: true },
